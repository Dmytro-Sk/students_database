...
urlpatterns = [
    ...
    path('students/<int:sid>/edit', students_views.students_edit, name='students-edit'),
    path('students/<int:sid>/delete', students_views.students_delete, name='students-delete'),
    ...
    path('classes/<int:gid>)/edit', students_views.classes_edit, name='classes-edit'),
    path('classes/<int:gid>)/delete', students_views.classes_delete, name='classes-delete'),
]
